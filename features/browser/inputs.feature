Feature: Inputs
  ...
  Scenario: Can write into an <input type="date">
  ...
  @disabled
  Scenario: Can write into an <input type="datetime-local">
  ...
  Scenario: Can write into an <input type="email">
  ...
  @disabled
  Scenario: Can write into an <input type="month">
  ...
  Scenario: Can write into an <input type="number">
  ...
  Scenario: Can write into an <input type="password">
  ...
  Scenario: Can write into an <input type="search">
  ...
  Scenario: Can write into an <input type="tel">
  ...
  Scenario: Can write into an <input type="text">
  ...
  Scenario: Can write into an <input type="time">
  ...
  Scenario: Can write into an <input type="url">
  ...
  Scenario: Can write into an <input type="week">
  ...
  Scenario: Can write into an <input> with label for

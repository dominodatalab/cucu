Feature: Fuzzy rules
  ...
  Scenario: User matches on element with previous common grandparent
    Given I should see the radio button "first radio button with common grandparent" is selected
      And I should see the radio button "second radio button with common grandparent" is not selected
     When I select the radio button "second radio button with common grandparent"
     Then I should see the radio button "first radio button with common grandparent" is not selected
      And I should see the radio button "second radio button with common grandparent" is selected

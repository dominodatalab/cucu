...
Feature: Report basics
  ...
  Scenario: User can run with a runtime timeout and still produce a valid report
    Given I run the command "cucu run data/features/slow_features --runtime-timeout 10 --results {CUCU_RESULTS_DIR}/runtime_timeout_reporting_results" and expect exit code "1"

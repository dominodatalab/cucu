Feature: Report
  ...
  Scenario: User can run a multi scenario test with web steps and generate a valid report
    Given I run the command "cucu run data/features/multiple_scenarios_with_browser_steps.feature --results {CUCU_RESULTS_DIR}/multi-scenario-browser-results" and save exit code to "EXIT_CODE"
     ...
     When I click the link "Scenario: Search for cats on www.google.com"
     Then I should not see the image with the alt text "Given I search for \"define: dogs\" on google search"
      And I should see the image with the alt text "When I open a browser at the url \"https://www.google.com/search\""
      And I should see the image with the alt text "And I wait to write \"define: cats\" into the input \"Search\""
      And I should see the image with the alt text "And I click the button \"Google Search\""
      And I should see the image with the alt text "Then I should see the text \"Cat - Wikipedia\""
     When I click the link "Top"
      And I click the link "Feature: Multiple scenarios with browser steps"
      And I click the link "Scenario: Search for dogs on www.google.com"
     Then I should not see the image with the alt text "Given I search for \"define: dogs\" on google search"
      And I should see the image with the alt text "When I open a browser at the url \"https://www.google.com/search\""
      And I should see the image with the alt text "And I wait to write \"define: dogs\" into the input \"Search\""
      And I should see the image with the alt text "And I click the button \"Google Search\""
      And I should see the image with the alt text "Then I should see the text \"Dog - Wikipedia\""

...
Feature: Collect Tags
  As a developer
  I want to run the collect-tags command
  So that I can see which tags are associated with a given `cucu run`

  Scenario: User can run the collect-tags command
    Given I run the command "cucu collect-tags data/features/tagged_features" and save stdout to "STDOUT" and expect exit code "0"
  ...
  Scenario: User can filter on the collect-tags command
    Given I run the command "cucu collect-tags data/features/tagged_features --filter=fea" and save stdout to "STDOUT" and expect exit code "0"
     Then I should see "{STDOUT}" matches the following
      """
      feature1
      feature2
     ...
     When I run the command "cucu collect-tags data/features/tagged_features --filter=scen" and save stdout to "STDOUT" and expect exit code "0"
     Then I should see "{STDOUT}" matches the following
      """
      scenario1
      """
  ...
  Scenario: User can use the --tags argument with the collect-tags command
    Given I run the command "cucu collect-tags data/features/tagged_features --tags=feature1" and save stdout to "STDOUT" and expect exit code "0"
     Then I should see "{STDOUT}" matches the following
      """
      feature1
      scenario1
  ...
  Scenario: User can use the --tags argument and --filter argument on the collect-tags command at the same time
    Given I run the command "cucu collect-tags data/features/tagged_features --tags=feature1 --filter=fea" and save stdout to "STDOUT" and expect exit code "0"
     Then I should see "{STDOUT}" matches the following
      """
      feature1
      """
  ...
  Scenario: User is issued a reasonable error after providing an invalid filter
    Given I run the command "cucu collect-tags data/features/tagged_features --tags=feature1 --filter=nope(" and save stdout to "STDOUT" and expect exit code "5"
     Then I should see "{STDOUT}" matches the following
      """
  ...
  Scenario: User can collect tags without applying redaction to them
    Given I create a file at "{CUCU_RESULTS_DIR}/features_with_secrets/environment.py" with the following:
      ...
      """
     When I run the command "cucu collect-tags {CUCU_RESULTS_DIR}/features_with_secrets" and save stdout to "STDOUT", stderr to "STDERR" and expect exit code "0"

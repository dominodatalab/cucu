...
from cucu.steps.table_steps import check_table_contains_matching_rows_in_table, do_not_find_table
...
class TestDoNotFindTable(TestCase):
        ...
        with mock.patch("cucu.steps.table_steps.behave_table_to_array", expected_mock):
            ...
            with mock.patch("cucu.steps.table_steps.find_tables", tables_mock):
                ...
                with self.assertRaises(RuntimeError):
                    do_not_find_table(dummy, check_table_contains_matching_rows_in_table)
    ...
    def test_do_not_find_table(self):
        ...
        with mock.patch("cucu.steps.table_steps.behave_table_to_array", expected_mock):
            ...
            with mock.patch("cucu.steps.table_steps.find_tables", tables_mock):
                dummy = mock.MagicMock()
                result = do_not_find_table(dummy, check_table_contains_matching_rows_in_table)

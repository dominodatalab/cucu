...
# 1.4.10
- Fix - `_get_local_address` respects `HOST_ADDRESS` env var and gracefully falls back to `127.0.0.1` on `OSError`, preventing crashes in network-restricted environments (e.g. CI lint sandboxes)
